...
path = "/home/manal/Desktop/projetIA/DeepLearning/"
...
labels = ['Mercedes', 'BMW', 'KIA', 'Opel', 'Ferrari', 'Fiat', 'Ford', 'Renault', 'Volkswagen', 'Jaguar']

x_train, y_train = load_data(path, labels, dataset='Train', image_size=150)
